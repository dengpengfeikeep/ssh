...
<body>
	...
	<form name="editForm" namespace="/" action="supplier_saveOrUpdate"
			...
			<div class="ui_content">
				<table cellspacing="0" cellpadding="0" width="100%" align="left"
					...
					<tr>
						...
						<td class="ui_text_lt"><s:textfield name="supplier.name"
								cssClass="ui_input_txt02">
							</s:textfield></td>
					</tr>
					<tr>
						<td class="ui_text_rt" width="140">供应商地址</td>
						<td class="ui_text_lt"><s:textfield name="supplier.address"
								cssClass="ui_input_txt02">
							</s:textfield></td>
					</tr>
					<tr>
						<td class="ui_text_rt" width="140">联系电话</td>
						<td class="ui_text_lt"><s:textfield name="supplier.phone"
								cssClass="ui_input_txt02">
							</s:textfield></td>
					</tr>
					<tr>

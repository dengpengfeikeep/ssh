...
<script type="text/javascript">
	...
	$(function() {
		...
		//加上My97Date控件
		$("input[name='stockOutcomeBill.vdate']").addClass("Wdate").click(
				function() {
					WdatePicker({
						//可选的选项
						maxDate : new Date(),
		...
		$("#edit_table_body").on("change",
				"input[tag='salePrice'],input[tag='number']", function() {
					var salePrice = $("input[tag='salePrice']").val();
					var number = $("input[tag='number']").val();
					$("input[tag='amount']").val(number * salePrice);
				});
...
<body>
	...
	<!--====================================-->
	<s:form name="editForm" action="stockOutcomeBill_saveOrUpdate"
				...
				<table cellspacing="0" cellpadding="0" width="100%" align="left"
					...
					<tr>
						...
						<td class="ui_text_lt"><s:textfield
								name="stockOutcomeBill.sn" cssClass="ui_input_txt02" /></td>
					</tr>
					<tr>
						<td class="ui_text_rt" width="140">仓库</td>
						<td class="ui_text_lt"><s:select list="#depots"
								name="stockOutcomeBill.depot.id" listKey="id" listValue="name"
								cssClass="ui_select03" /></td>
					</tr>
					<tr>
						<td class="ui_text_rt" width="140">客户</td>
						<td class="ui_text_lt"><s:select list="#clients"
								name="stockOutcomeBill.client.id" listKey="id" listValue="name"
								cssClass="ui_select03" /></td>
					</tr>
					<tr>
						<td class="ui_text_rt" width="140">业务时间</td>
						<td class="ui_text_lt"><s:textfield
								name="stockOutcomeBill.vdate" cssClass="ui_input_txt02" /></td>
					</tr>
					<tr>
						...
						<td><input type="button" value="添加明细"
							...
							<table class="edit_table" cellspacing="0" cellpadding="0"
								...
								<tbody id="edit_table_body">
										...
										<tr>
											...
											<td><s:textfield disabled="true" readonly="true"
												...
												class="searchproduct" /> <s:hidden
													name="stockOutcomeBill.items.product.id" tag="pid" /></td>
											<td><s:textfield tag="brand"
													name="stockOutcomeBill.items.brand.name"
													cssClass="ui_input_txt04" readonly="true" /></td>
											<td><s:textfield tag="salePrice"
											...
											<td><s:textfield tag="amount"
													name="stockOutcomeBill.items.amount"
													cssClass="ui_input_txt04" readonly="true" /></td>
									...
									<!--更新  -->
									<s:else>
										<s:iterator value="stockOutcomeBill.items"></s:iterator>
										<tr>
											<td></td>
											<td><s:textfield disabled="true" readonly="true"

...
<body>
	...
	<form name="editForm" namespace="/" action="department_saveOrUpdate"
			...
			<div class="ui_content">
				<table cellspacing="0" cellpadding="0" width="100%" align="left"
					...
					<tr>
						...
						<td class="ui_text_lt"><s:textfield name="department.name"
								cssClass="ui_input_txt02">
							</s:textfield></td>
					</tr>
					<tr>
						<td class="ui_text_rt" width="140">部门代码</td>
						<td class="ui_text_lt"><s:textfield name="department.sn"
								cssClass="ui_input_txt02">
							</s:textfield></td>
					</tr>
					<tr>

...
<body>
	...
	<form name="editForm" namespace="/" action="systemMenu_saveOrUpdate"
			...
			<div class="ui_content">
				<table cellspacing="0" cellpadding="0" width="100%" align="left"
					...
					<tr>
						...
						<td class="ui_text_lt"><s:textfield value="%{parentName}"
								cssClass="ui_input_txt02" readonly="true">
								<s:hidden name="qo.parentId"></s:hidden>
							</s:textfield></td>
					</tr>
					<tr>
						<td class="ui_text_rt" width="140">name</td>
						<td class="ui_text_lt"><s:textfield name="systemMenu.name"
								cssClass="ui_input_txt02">
							</s:textfield></td>
					</tr>
					<tr>
						<td class="ui_text_rt" width="140">sn</td>
						<td class="ui_text_lt"><s:textfield name="systemMenu.sn"
								cssClass="ui_input_txt02">
							</s:textfield></td>
					</tr>
					<tr>
						<td class="ui_text_rt" width="140">url</td>
						<td class="ui_text_lt"><s:textfield name="systemMenu.url"
								cssClass="ui_input_txt02">
							</s:textfield></td>
					</tr>
					<tr>
